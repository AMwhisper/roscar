...
class Can(metaclass=Metaclass_Can):
    ...
    def __init__(self, **kwargs):
        ...
        self.can = array.array('f', kwargs.get('can', []))
    ...
    def can(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'f', \
                "The 'can' array.array() must have the type code of 'f'"
            self._can = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'can' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        self._can = array.array('f', value)
