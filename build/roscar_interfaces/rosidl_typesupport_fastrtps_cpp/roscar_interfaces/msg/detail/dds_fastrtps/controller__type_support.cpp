...
#include "roscar_interfaces/msg/detail/controller__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const roscar_interfaces::msg::Controller & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roscar_interfaces::msg::Controller & ros_message)
{
  // Member: lx
  cdr >> ros_message.lx;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roscar_interfaces::msg::Controller;
    is_plain =
      (
      offsetof(DataType, x) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const roscar_interfaces::msg::Controller *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roscar_interfaces::msg::Controller *>(
    untyped_ros_message);
...
{
  return &roscar_interfaces::msg::typesupport_fastrtps_cpp::_Controller__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roscar_interfaces, msg, Controller)() {
  return &roscar_interfaces::msg::typesupport_fastrtps_cpp::_Controller__handle;
}
