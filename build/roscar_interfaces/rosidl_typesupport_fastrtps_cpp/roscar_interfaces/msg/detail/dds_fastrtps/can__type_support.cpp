...
#include "roscar_interfaces/msg/detail/can__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const roscar_interfaces::msg::Can & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roscar_interfaces::msg::Can & ros_message)
{
  // Member: can
  {
    cdr >> ros_message.can;
  ...
  size_t current_alignment)
{
  ...
  // Member: can
  {
    ...
    size_t item_size = sizeof(ros_message.can[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roscar_interfaces::msg::Can;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roscar_interfaces::msg::Can *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roscar_interfaces::msg::Can *>(
    untyped_ros_message);
...
{
  return &roscar_interfaces::msg::typesupport_fastrtps_cpp::_Can__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roscar_interfaces, msg, Can)() {
  return &roscar_interfaces::msg::typesupport_fastrtps_cpp::_Can__handle;
}
