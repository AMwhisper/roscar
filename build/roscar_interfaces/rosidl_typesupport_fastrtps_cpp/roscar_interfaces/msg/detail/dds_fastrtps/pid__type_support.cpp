...
#include "roscar_interfaces/msg/detail/pid__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const roscar_interfaces::msg::Pid & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: chassis_pid
  {
    cdr << ros_message.chassis_pid;
  }
  // Member: gimbal_pid
  {
    cdr << ros_message.gimbal_pid;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roscar_interfaces::msg::Pid & ros_message)
{
  // Member: chassis_pid
  {
    cdr >> ros_message.chassis_pid;
  ...
  size_t current_alignment)
{
  ...
  // Member: chassis_pid
  {
    ...
    size_t item_size = sizeof(ros_message.chassis_pid[0]);
  ...
  // Member: gimbal_pid
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.gimbal_pid[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roscar_interfaces::msg::Pid;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roscar_interfaces::msg::Pid *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roscar_interfaces::msg::Pid *>(
    untyped_ros_message);
...
{
  return &roscar_interfaces::msg::typesupport_fastrtps_cpp::_Pid__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roscar_interfaces, msg, Pid)() {
  return &roscar_interfaces::msg::typesupport_fastrtps_cpp::_Pid__handle;
}
