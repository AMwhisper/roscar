...
static const _Can_type_support_symbol_names_t _Can_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roscar_interfaces, msg, Can)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roscar_interfaces, msg, Can)),
  }
};
...
{
  return &::roscar_interfaces::msg::rosidl_typesupport_cpp::Can_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, roscar_interfaces, msg, Can)() {
  return get_message_type_support_handle<roscar_interfaces::msg::Can>();
}
