...
#include "roscar_interfaces/msg/detail/controller__rosidl_typesupport_fastrtps_c.h"
...
using _Controller__ros_msg_type = roscar_interfaces__msg__Controller;
...
size_t get_serialized_size_roscar_interfaces__msg__Controller(
  const void * untyped_ros_message,
...
static uint32_t _Controller__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roscar_interfaces__msg__Controller(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roscar_interfaces
size_t max_serialized_size_roscar_interfaces__msg__Controller(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roscar_interfaces__msg__Controller;
    is_plain =
      (
      offsetof(DataType, x) +
      last_member_size
...
static size_t _Controller__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_roscar_interfaces__msg__Controller(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roscar_interfaces, msg, Controller)() {
