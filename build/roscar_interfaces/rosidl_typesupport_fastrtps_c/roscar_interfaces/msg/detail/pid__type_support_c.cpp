...
#include "roscar_interfaces/msg/detail/pid__rosidl_typesupport_fastrtps_c.h"
...
using _Pid__ros_msg_type = roscar_interfaces__msg__Pid;
...
size_t get_serialized_size_roscar_interfaces__msg__Pid(
  const void * untyped_ros_message,
...
static uint32_t _Pid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roscar_interfaces__msg__Pid(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roscar_interfaces
size_t max_serialized_size_roscar_interfaces__msg__Pid(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Pid__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_roscar_interfaces__msg__Pid(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roscar_interfaces, msg, Pid)() {
