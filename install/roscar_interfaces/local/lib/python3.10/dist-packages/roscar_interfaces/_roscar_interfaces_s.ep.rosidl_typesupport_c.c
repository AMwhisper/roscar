...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "roscar_interfaces/msg/detail/can__type_support.h"
#include "roscar_interfaces/msg/detail/can__struct.h"
#include "roscar_interfaces/msg/detail/can__functions.h"

static void * roscar_interfaces__msg__can__create_ros_message(void)
{
  return roscar_interfaces__msg__Can__create();
}

static void roscar_interfaces__msg__can__destroy_ros_message(void * raw_ros_message)
{
  roscar_interfaces__msg__Can * ros_message = (roscar_interfaces__msg__Can *)raw_ros_message;
  roscar_interfaces__msg__Can__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool roscar_interfaces__msg__can__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * roscar_interfaces__msg__can__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(roscar_interfaces, msg, Can);
...
_register_msg_type__msg__can(PyObject * pymodule)
{
  ...
  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&roscar_interfaces__msg__can__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&roscar_interfaces__msg__can__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&roscar_interfaces__msg__can__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&roscar_interfaces__msg__can__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(roscar_interfaces, msg, Can),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "roscar_interfaces/msg/detail/pid__type_support.h"
#include "roscar_interfaces/msg/detail/pid__struct.h"
#include "roscar_interfaces/msg/detail/pid__functions.h"

static void * roscar_interfaces__msg__pid__create_ros_message(void)
{
  return roscar_interfaces__msg__Pid__create();
}

static void roscar_interfaces__msg__pid__destroy_ros_message(void * raw_ros_message)
{
  roscar_interfaces__msg__Pid * ros_message = (roscar_interfaces__msg__Pid *)raw_ros_message;
  roscar_interfaces__msg__Pid__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool roscar_interfaces__msg__pid__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * roscar_interfaces__msg__pid__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(roscar_interfaces, msg, Pid);
...
_register_msg_type__msg__pid(PyObject * pymodule)
{
  ...
  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&roscar_interfaces__msg__pid__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&roscar_interfaces__msg__pid__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&roscar_interfaces__msg__pid__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&roscar_interfaces__msg__pid__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(roscar_interfaces, msg, Pid),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
